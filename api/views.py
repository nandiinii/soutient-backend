...
from .models import (MetamaskUser, Election,Vote,CampaignDonation,LoanInterested,LoanRequest,Campaign,Review,InterestConfirmedAndContractDone)
from .serializers import (MetamaskUserSerializer, ElectionSerializer,VoteSerializer,CampaignDonationSerializer,CampaignSerializer,
                          LoanInterestSerializer,LoanRequestSerializer,ReviewSerializer,InterestConfirmedAndContractDoneSerializer)
...
class InterestConfirmedAndContractDoneViewSet(viewsets.GenericViewSet,mixins.CreateModelMixin,mixins.RetrieveModelMixin,mixins.ListModelMixin):
    serializer_class=InterestConfirmedAndContractDoneSerializer
    queryset=InterestConfirmedAndContractDone.objects.all()
